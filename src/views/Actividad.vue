  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Maquetación sitio web
        p.mb-4 Fortalecer los conocimientos de maquetación empleando las tecnologías de HTML, CSS y JavaScript, que permitan el uso de plantilla web y  librerías CSS.
